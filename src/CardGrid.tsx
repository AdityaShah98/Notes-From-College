...
const professors: Professor[] = [
  ...
  {name: "Cara Esposito", route: "CaraEsposito", image: cara, description: "Abby Fifer Mandell is a great professor who absolutely changed my life in almost every way."},
  {name: "Carmen Lee", route: "CarmenLee", image: carmen, description: "Abby Fifer Mandell is a great professor who absolutely changed my life in almost every way."},
  {name: "Chimamanda Ngozi Adiche", route: "ChimamandaNgoziAdiche", image: chimamanda, description: "Abby Fifer Mandell is a great professor who absolutely changed my life in almost every way."},
  {name: "Dr. Alissa Richardson", route: "DrAlissaRichardson", image: alissa, description: "Abby Fifer Mandell is a great professor who absolutely changed my life in almost every way."},
